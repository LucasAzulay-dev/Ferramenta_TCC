...
int SUT(int SUTI1, int SUTI2, int SUTI3, int SUTI4, int SUTI5, int SUTI6, int SUTI7, int *SUTO1, long *SUTO2)
{
  ...
  *SUTO2 = CompE(CO1);
  sprintf(log_buffer + strlen(log_buffer), "{\"function\": \"CompE\", \"executionOrder\": \"5\", \"in\": {\"CO1\": \"%d\"}, \"out\": {\"SUTO2\": \"%ld\"}},\n",CO1,*SUTO2);
  teste_return = CompF(CO1);
  sprintf(log_buffer + strlen(log_buffer), "{\"function\": \"CompF\", \"executionOrder\": \"6\", \"in\": {\"CO1\": \"%d\",\"teste_return\": \"None\"}, \"out\": {}},\n",CO1,teste_return);
  return teste_return;
}
