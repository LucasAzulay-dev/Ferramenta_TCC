...
int main(){
  int test_vecs_SUTI1[2] = {35, 0};
  int test_vecs_SUTI2[2] = {30, -10};
  int test_vecs_SUTI3[2] = {34, -1};
  int test_vecs_SUTI4[2] = {3.4, 30};
  int test_vecs_SUTI5[2] = {11, 40};
  int test_vecs_SUTI6[2] = {13, 50};
  int test_vecs_SUTI7[2] = {11, 60};
  int test_vecs_SUTO1[2] = {2, 1};
  long test_vecs_SUTO2[2] = {3, 4};
